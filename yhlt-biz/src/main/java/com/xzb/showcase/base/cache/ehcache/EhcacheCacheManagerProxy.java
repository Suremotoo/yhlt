...
//					LOGGER.warn("cluster clusterOffline,nodeIp=" + (node == null ? "null" : node.getIp()));
//				}
				innerFlag = false;
			}
		});
	...
	private void initSimpleCacheManager(){
		...
		ConcurrentMapCache memoryOnlyCache = new ConcurrentMapCache(SIMPLE_CACHE_NAME);
//		net.sf.ehcache.Cache memoryOnlyCache = new net.sf.ehcache.Cache(SIMPLE_CACHE_NAME, 5000, false, false, 30, 20);

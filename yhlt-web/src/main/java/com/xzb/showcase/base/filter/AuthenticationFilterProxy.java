...
import com.xzb.showcase.base.util.CasUtil;
...
public class AuthenticationFilterProxy extends AbstractCasFilter {
    ...
    public final void doFilter(final ServletRequest servletRequest, final ServletResponse servletResponse, final FilterChain filterChain) throws IOException, ServletException {
        ...
        if(IpUtil.isValidIpByCas(ipAndPort[0]) && !IpUtil.isValidIpByCas(casIpAndPort[0])){
        ...
        urlToRedirectTo = CommonUtils.constructRedirectUrl(tmpCasServerLoginUrl, getServiceParameterName(), modifiedServiceUrl, this.renew, this.gateway);

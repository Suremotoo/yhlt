...
<script type="text/javascript">
	...
	$(function () {
	   	resourcesCombotree=$('#resourceInfoFormId').combotree({
	        ...
	        valueField: 'id',
	        nameField: 'name',
	        url: '${dynamicURL}/system/resources/combotree?search_EQ_parentId=0&search_EQ_flag=1'
	     });
		resourcesTreegrid = $('#resourcesTreegrid').treegrid({
            url: '${dynamicURL}/system/resources/treegrid?search_EQ_parentId=0&search_EQ_flag=1',

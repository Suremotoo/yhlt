...
<div id="container">
    <form class="editInfoFrm" action="${dynamicURL}/system/user/save" method="post">
    	<input type="hidden" name="id" value="${entity.id}"/>
    	<input type="hidden" name="password" value="${entity.password}"/>
    	<input type="hidden" name="loginName" value="${entity.loginName}"/>
    	<input type="hidden" id="companyEntityId" value="${entity.companyEntity.id}"/>
    	...
    	<input type="hidden" id="sortNumber" name="sortNumber" value="${entity.sortNumber}"/>
        ...
        <div title="个人信息" style="padding: 20px; height: 680px;">
                ...
                <div style="padding: 5px; width: 98%; height: auto" class="easyui-panel" id="no1" title="个人信息">
                    ...
                    <table class="conDetailTable">
                        <tr>
                            ...
                            <td width="35%">
                                <input class="easyui-textbox" type="text"  id="loginName" value="${entity.loginName}"  style="width: 270px; height: 26px;"  disabled="disabled" />
                            </td>
                            <td width="15%" class="tr">&nbsp;</td>
                            <td rowspan="4" width="35%" style="text-align: center;">
                                <div class="imgUploadBlock" onclick="openDiv();">
                                    <img id="yl" src="${entity.headImgUrl }" width="175" height="175"  />
                                </div>
                        ...
                        <tr>
                            ...
                            <td width="35%">
                            	<%-- <input class="easyui-textbox" type="text" name="companyEntity.id" id="companyEntity" value="${entity.companyEntity.name}"  style="width: 270px; height: 26px;"  disabled="disabled" /> --%>
                                <select name="companyEntity.id" id="companyFormId" style="width: 270px; height: 26px;" data-options="required:true" ></select>
                            </td>
                        </tr>
                        <tr>
                            <td width="15%" class="tr">部门名：&nbsp;&nbsp;</td>
                            <td width="35%">
                                <select class="easyui-textbox" name="departmentEntity.id" id="departmentFormId"  style="width: 270px; height: 26px" data-options="required:true"></select>
                            </td>
                        ...
                        <tr>
                            ...
                            <td width="35%">
                                <select class="easyui-textbox" name="positionEntity.id" id="positionFormId" style="width: 270px; height: 26px" data-options="required:true"></select>
                            </td>
                         ...
                         <tr>
                            ...
                            <td width="35%">
                                <select name="display" id="displayFormId" style="width: 270px; height: 26px" data-options="required:true" >
                           ...
                           <tr>
                            ...
                            <td width="35%">
                                <input class="easyui-textbox" type="text" name="cardNo"  value="${entity.cardNo}"  style="width: 270px; height: 26px;"/>
                            </td>
                        </tr>
                        <tr>
                            <td width="15%" class="tr">身份证号：&nbsp;&nbsp;</td>
                            <td width="35%">
                                <input class="easyui-textbox" type="text" name="idCard" value="${entity.idCard}"  style="width: 270px; height: 26px;"/>
                            </td>
                        </tr>
                    </table>
                </div>
                <div style="padding: 5px; width: 98%; height: auto" class="easyui-panel" id="no2" title="基本资料">
                    ...
                    <table class="conDetailTable">
                        ...
                        <tr>
                            ...
                            <td class="tr">出生日期：&nbsp;&nbsp;</td>
                            <td style="">
                                <input class="easyui-datebox" data-options="editable:true" name="birthday" value="${entity.birthday}" type="text" id="birthday"  style="width: 270px; height: 26px" />
                            </td>
                        </tr>
                       <tr>
							<td style="width: 15%;" class="tr">第一学历：&nbsp;&nbsp;</td>
							<td style="width: 35%;">
								<select id="education1" name="education1" style="width: 270px; height: 26px">
							...
							<td style="width: 35%;">
								<select id="education2" name="education2" style="width: 270px; height: 26px">
										<option value="">无</option>
										<option value="小学">小学</option>
										<option value="初中">初中</option>
										<option value="高中">高中</option>
            ...
            <div class="BtnLine">
                ...
                <button type="button" class="easyui-linkbutton" onClick="window.parent.parent.reLoad('修改人员');">关闭</button>
            </div>
        </div>
       </form>
    </div>
    ...
    <table style="width:100%">
        ...
        <tr>
            <td style="text-align: center; height: 240px;">
                <div id="preview">
				    <img id="imghead" border=0 src="${entity.headImgUrl }" width="240" height="240" />
				</div>
            </td>
        </tr>
        <tr>
...
<script>
	$(function(){
    	...
    	var depTree = $('#departmentFormId');
    	// 公司树
    	var comId = $("#companyEntityId").val();
    	$('#companyFormId').combotree({
		 	valueField:'id',
		 	nameField:'name',
            url: '${dynamicURL}/system/company/combotree?search_EQ_parentId=0',
            onLoadSuccess: function(){
            	$("#companyFormId").combotree("setValue",comId);
            	depTree.combotree("reload","${dynamicURL}/system/department/treegrid?companyId="+comId+"");

            	var depId = $("#departmentEntityId").val();
            	depTree.combotree("setValue",depId);
            	var posId = $("#positionEntityId").val();
				$("#positionFormId").combotree("setValue",posId);
            }, 
            onSelect:function(rec){
            	depTree.combotree("reload","${dynamicURL}/system/department/treegrid?companyId="+rec.id+"");
    	...
    	depTree.combotree({
    		valueField:'id',
		    nameField:'name',
            url: '${dynamicURL}/system/department/treegrid?companyId='+comId
     	});
	...
	$("#sex").val("${entity.sex}");
	$("#education1").val("${entity.education1}");
	$("#education2").val("${entity.education2}");
	//初始化form表单
